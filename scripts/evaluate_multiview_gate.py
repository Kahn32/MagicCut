...
def main():
    ...
    p24=read_json("reports/generated/interaction_experiments/report.json")["prompt_24"]["test"]["view_feature_disagreement"]
    ...
    write_json("reports/generated/multiview_gate/report.json",report);print(json.dumps(report,indent=2))
